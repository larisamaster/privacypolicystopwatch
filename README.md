This privacy policy governs your use of the software application Stopwatch Fast for mobile devices that was created by AD PROJECT. The Application is a simple mobile app and can be used by people of any age.
